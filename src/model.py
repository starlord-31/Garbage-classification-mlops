...
def get_model(model_name: str, num_classes: int, device: torch.device):
    ...
    for the specified number of classes. Features are frozen for transfer learning.
...
if __name__ == "__main__":
    ...
    for name, model in models_dict.items():
        print(f"Model {name} classifier structure:\n{model.classifier if hasattr(model, 'classifier') else model.fc if hasattr(model, 'fc') else model.heads.head}\n")
